...
public class DonationMade extends Donation {
	...
	/**
	 * Constructs a Donation Made Entity with specified values. Id is automatically generated.
	 * 
	 * @param item The Item that has been Donated.
	 * @param quantity The total amount of item donated.
	 * @param remaining The remaining amount of item donated that are not used/requested by Ngos.
	 */
