...
public class DonationRequested extends Donation {
	...
	/**
	 * Constructs a Donation Requested Entity with specified values. Id is automatically generated.
	 * 
	 * @param item The Item that has been Requested.
	 * @param quantity The total amount of item requested.
	 * @param remaining The remaining amount of item requested that are not fulfilled.
	 */
