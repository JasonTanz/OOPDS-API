 ...
 * This Controller is responsible for Controlling operations for Donation Requested Entities.
 */
@RestController
@RequestMapping("/dc")
public class DonationRequestedController {
    ...
    /**
	 * Gets and Sends all Donations Requested available in the database as a resource to the web.
	 * If there's no Donations Requested in the database (null), then it will return a HTTP error code.
	 * 
	 * @return a ResponseEntity Object, which contains a List of Donations Requested and the appropriate HTTP Response Code or only a HTTP Response Code to the web.
    ...
    /**
	 * Gets and Sends the Donation Requested based on ID in the database as a resource to the web.
	 * If there's no Donation Requested with the specified ID, then it will return a HTTP error code.
	 * 
	 * @return a ResponseEntity Object, which contains the Donation Requested and the appropriate HTTP Response Code or only a HTTP Response Code to the web.
	 * @throws Exception Any exceptions in operation will return a HTTP error code.
	 */
    ...
    /**
	 * Gets and Sends all Donations Requested based on their total quantity of items requested in the database as a resource to the web.
	 * If there's no onations Requested matching the total quantity of items requested specified in the database (null), then it will return a HTTP error code.
	 * 
	 * @return a ResponseEntity Object, which contains a List of Donations Requested and the appropriate HTTP Response Code or only a HTTP Response Code to the web.
	 * @throws Exception Any exceptions in operation will return a HTTP error code.
	 */
    ...
    /**
	 * Gets and Sends all Donations Requested based on their remaining quantity of items requested in the database as a resource to the web.
	 * If there's no onations Requested matching the remaining quantity of items requested specified in the database (null), then it will return a HTTP error code.
	 * 
	 * @return a ResponseEntity Object, which contains a List of Donations Requested and the appropriate HTTP Response Code or only a HTTP Response Code to the web.
	 * @throws Exception Any exceptions in operation will return a HTTP error code.
	 */
