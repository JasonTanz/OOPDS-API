...
public class DonationMadeController {
    ...
    /**
    * This is a constructor for the DonationMadeController controller with the specified parameters
    *
    * @param donationMadeService The service class for Donations Made.
    * @param donorService The service class for Donors.
    */
    @Autowired
    public DonationMadeController(DonationMadeService donationMadeService, DonorService donorService) {
    ...
    */
    ...
    /**
    * This is a HTTP Get method to get all donation made available in the database.
    *
    ...
    */
    ...
    public DonationMade addDonationMade(@RequestBody Map<String, String> data) {
        ...
        // // List<DonationMade> d= donationMadeService.findAll();
        // return d;
    }
    ...
    // DonationMade donationMade = new DonationMade();
    // donationMade.setDonor(donorService.getById(UUID.fromString(data.get("donor_id"))));
    // donationMade.setItem(data.get("item"));
    // donationMade.setQuantity(Integer.parseInt(data.get("quantity")));
    // donationMade.setRemaining(Integer.parseInt(data.get("remaining")));
    // donationMadeService.add(donationMade);
    // return donationMadeService.getAll();
    // }
}